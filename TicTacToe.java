public class TicTacToe {
    ...
    public static boolean validMarks(Character[][] board) {
    ...
    public static void main(String[] args) {
        ...
        // Check if board is square and if there are only valid marks
        // Check if there is a winner and display results
        if (isSquare(winnerBoard)) {
            if (validMarks(winnerBoard)) {
                ...
                System.out.println("Invalid Tic-Tac-Toe marks");
            }
        } else {
            System.out.println("Incorrect Tic-Tac-Toe board dimensions!");
        }
    }
}
